<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if(isset($_POST['valid'])) {
            ...
            if(!$error) {
                //permet de vérifier si l'image est envoyé car c'est optionnel
                if($ImageSize > 0) {
            ...
            if(!$error) {
                ...
                editArticle($Titre,$Prix,$Cerise,$CeriseBonus,$Available,$IdArticle);
    
                //Ajoute l'image
                move_uploaded_file($ImageUrl, $_SERVER['DOCUMENT_ROOT'].'/images/'.(string)$article['LinkImg']);
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description">Ce formulaire permet de modifier un article dans la boutique.</p>
                    <form method="post" enctype="multipart/form-data" class="forms-sample">
                      <div class="form-group">
                        <label for="Titre">Titre</label>
                        <input type="text" class="form-control" name="Titre" id="Titre" value="<?= $article['Titre'] ?>" autocomplete="off">
                      </div>

                      <div class="form-group">
                        <label for="Prix">Prix</label>
                        <p class="card-description">La virgule doit être remplacé par un point.</p>
                        <input type="number" step=0.01 class="form-control" name="Prix" id="Prix" value="<?= $article['Prix'] ?>">
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="number" name="Cerise" id="Cerise" class="form-control" value="<?= $article['Cerise'] ?>">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="number"name="CeriseBonus" id="CeriseBonus" class="form-control" value="<?= $article['CeriseBonus'] ?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input onchange="document.getElementById('imgChange').src = window.URL.createObjectURL(this.files[0])" type="text" class="form-control file-upload-info" disabled="" placeholder="Image Télécharger">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">Aperçu de l'image</div>
                            <img id="imgChange" src="/images/<?= $article['LinkImg'] ?>" alt="<?= $article['LinkImg'] ?>" class="img-thumbnail">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="form-check form-check-flat form-check-primary">
                            ...
                            <input type="checkbox" name="Available" id="Available" class="form-check-input" <?php if($article['Available']) {echo'checked';} ?>> Visible dans la Boutique <i class="input-helper"></i></label>
                        </div>
                      </div>
